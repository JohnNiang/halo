...
public class FunctionalMultiValueIndexAttribute
    <E extends Extension, T extends Comparable<? super T>> extends AbstractIndexAttribute<E, T> {

    @EqualsAndHashCode.Exclude
    private final Function<E, Set<T>> valueFunc;
    ...
    private Set<T> getNonNullValues(E object) {
