...
CREATE
    TABLE
        IF NOT EXISTS users(
            name VARCHAR(255) NOT NULL COLLATE utf8mb4_bin,
            display_name VARCHAR(255) COLLATE utf8mb4_bin,
            email VARCHAR(255),
...
CREATE
    TABLE
        IF NOT EXISTS extension_labels(
            extension_name VARCHAR(255) NOT NULL COLLATE utf8mb4_bin,
            label_key VARCHAR(255) NOT NULL COLLATE utf8mb4_bin,
            label_value VARCHAR(255) NOT NULL COLLATE utf8mb4_bin,
            PRIMARY KEY(
                extension_name,
                label_key
            )
...
CREATE
    TABLE
        IF NOT EXISTS user_roles(
            store_name VARCHAR(255) NOT NULL COLLATE utf8mb4_bin,
